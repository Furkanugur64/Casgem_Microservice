    ...
    public static class Config
    {
        ...
        public static IEnumerable<IdentityResource> IdentityResources =>
                   new IdentityResource[]
                   {
                       ...
                       new IdentityResource()
                       {
                           Name="roles",DisplayName="Roles",Description="Kullanıcı Roller",UserClaims=new []{"role"}
                       }
                   };
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
                new ApiScope("catalog_fullpermission","Katalog API için full erişim"),
                    new ApiScope("photo_stock_fullpermission","Fotoğraf Stoğu API için full erişim"),
        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                // Sisteme giriş yapmayan kullanıcılar
                new Client
                {
                   ClientName="Casgem1",
                ...
                new Client
                {
                    ...
                    AllowedScopes={ "catalog_fullpermission", "photo_stock_fullpermission", "basket_fullpermission", "discount_fullpermission", "order_fullpermission", "payment_fullpermission",
